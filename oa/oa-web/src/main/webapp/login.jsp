...
<div id="bg">
<table  width="100%" border="0" cellSpacing="0" cellPadding="0" style="position:fixed;left:0;top:0px;background: transparent;">
<tr>
...
<tr>
<td height="50"  class="field-label">账&nbsp;号&nbsp;</td><td align="left"><input id="userid"  autocomplete="off"  class="ipt" type="text" name="userid"> </td>
</tr>
<tr>
<td height="50"  class="field-label">密&nbsp;码&nbsp;</td><td align="left"><input id="password"  autocomplete="off"  class="ipt" type="password" name="password"></td>
</tr>
<tr>
<td height="50"  class="field-label">验证码&nbsp;</td><td align="left"><input id="code"  autocomplete="off"  class="ipt" type="text" name="code" style="width:80px;"> <img id="yzm" align="absmiddle" title="看不清，请单击" style="cursor:pointer" src="verifyCodeImage" onclick="javascript:this.src='verifyCodeImage?random='+Math.random()"> </td>
</tr>
<tr>
...
<button onclick="login();" style="width:260px;height:40px;line-height:40px;background-color:#009688;color:#fff;font-size:20px;cursor:pointer;" class="yj05">登  录</button>
 </td>
</tr>
<tr>
...
<tr>
<td style="" align="center">
<div style="width:1000px;height:100px;font-size:12px;color:#fff"><br/>
