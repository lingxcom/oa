...
layui.use(['tree', 'util'], function(){
	$.post("lingx/auth/handler.jsp",{c:"menu_tree",roleid:params.id,node:0,retType:"layui",lgxsn:1},function(json){
		   tree = layui.tree
		  ,util = layui.util;
		  ...
		  for(var i=0;i<json.checkedList.length;i++){
			  arr.push(json.checkedList[i].menu_id)
		  }
...
function lingxSubmit(){
	...
	$.post("lingx/auth/handler.jsp",{c:"menu_save",roleid:params.id,menuids:treeIds},function(json){
		lgxInfo(json.message)
		closeWindow()
	},"json");
