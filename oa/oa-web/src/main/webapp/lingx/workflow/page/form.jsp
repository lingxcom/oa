...
<script type="text/javascript" src="lingx/js/rootApi_Layui.js"></script>
<style type="text/css">
a:link{
...
<script type="text/javascript" src="lingx/workflow/page/form.js?12"></script>
</head>
<body>
...
<td colspan="2" >
<hr/>
<div class="panel panel-success opinion">
