	...
	_this.line2=function(offset,point,width,height,id,type){
		...
		case 0://上
			...
			if(type==1)
				...
				line.css("border-left","1px solid #fb6d5a");
			break;
		case 1://右
			line.offset(offset);
			line.width(width);
			if(type==1)
				...
				line.css("border-top","1px solid #fb6d5a");
		...
		case 0://上
			...
			for(var i=0;i<px;i++){
				...
				if(type==1)
					...
					l.css("border-top","1px solid #fb6d5a");
			}
			break;
		case 1://右
			...
			for(var i=0;i<px;i++){
				...
				if(type==1)
					...
					l.css("border-left","1px solid #fb6d5a");
			}
			break;
		case 2://下
