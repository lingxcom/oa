...
com.lingx.support.web.listener.OnlineUserManager onlineUserManager=com.lingx.support.web.listener.OnlineUserManager.getOnlineUserManager();
...
<td>
<a  :href="'lingx/template/online.jsp?id='+el.remark">强制下线</a> 
