...
window.addEventListener("resize", function(){
	...
	$("body").height(height);
	$(".layui-tab-card").height(height-1);
	$(".layui-tab-content").height(height-42);
});
  ...
  $.post("g",{e:entityCode},function(json1){
	...
	//添加行操作
	 ...
	 var tableIns =table.render({
		    ...
		    ,cols: [columns]
		    ,page: true
		    ,height: "full-"+toolHeight//'full-400'
		    ,done:function(res, curr, count){
		    	var valId=res.data.length>0?res.data[0].id:"none";
				  ///////////////////////////////init grid_cascade
				  if(initTab)
