var LingxEditor=function(){
	...
	_this.init=function(){
		...
		/*li=$(" <li><a href='javascript:;'>文本框 bootstarp</a></li>").bind("click",function(){
			var ipt=$("<div class='input-group'>  <span class='input-group-addon'>Name</span>  <input autocomplete='off'   type='text' class='form-control'>  <span class='input-group-addon'>.00</span></div>");
			_this.addId(ipt);
			_this.bindClick(ipt);
			_this.currentEl.append(ipt);
		});
		...
		li=$(" <li><a href='javascript:;'>文本框 text</a></li>").bind("click",function(){
			var ipt=$("<span><input autocomplete='off'   type='text'  class='lingx-wf-ipt' authCfg='1,2,3,4,5,6,7,8,9' /></span>");
			_this.addId(ipt);
			_this.bindClick(ipt);
			_this.currentEl.append(ipt);
		});
		...
		/*li=$(" <li><a href='javascript:;'>签章</a></li>").bind("click",function(){
			...
			var ipt=$("<span><input autocomplete='off'   name='"+id+"' type='hidden' value='lingx/images/sign.png' /><img id='"+id+"' class='lingx-wf-sign lingx-wf-ipt' src='lingx/images/sign.png'></span>");
			_this.addId(ipt);
			_this.bindClick(ipt);
		...
		li=$(" <li><a href='javascript:;'>用户单选 user</a></li>").bind("click",function(){
			var ipt=$("<span><input autocomplete='off'   type='text' authCfg='1,2,3,4,5,6,7,8,9' class='lingx-wf-user lingx-wf-ipt' readonly /></span>");
			_this.addId(ipt);
			_this.bindClick(ipt);
			_this.currentEl.append(ipt);
		});
		...
		li=$(" <li><a href='javascript:;'>组织单选 org</a></li>").bind("click",function(){
			var ipt=$("<span><input autocomplete='off'   type='text' authCfg='1,2,3,4,5,6,7,8,9' class='lingx-wf-org lingx-wf-ipt' readonly /></span>");
			_this.addId(ipt);
			_this.bindClick(ipt);
			_this.currentEl.append(ipt);
		});
...
/*		li=$(" <li><a href='javascript:;'>选择域</a></li>").bind("click",function(){
		...
		li=$(" <li><a href='javascript:;'>对话框列表选择[单选]</a></li>").bind("click",function(){
			var ipt=$("<span><input autocomplete='off'   type='text' authCfg='1,2,3,4,5,6,7,8,9' class='lingx-wf-dialogoption lingx-wf-ipt' readonly /><button type='button' >选择</button></span>");
			_this.addId(ipt);
			_this.bindClick(ipt);
			_this.currentEl.append(ipt);
		});
		...
		li=$(" <li><a href='javascript:;'>对话框列表选择[多选]</a></li>").bind("click",function(){
			var ipt=$("<span><input autocomplete='off'   type='text' authCfg='1,2,3,4,5,6,7,8,9' class='lingx-wf-dialogoption2 lingx-wf-ipt' readonly /><button type='button' >选择</button></span>");
			_this.addId(ipt);
			_this.bindClick(ipt);
			_this.currentEl.append(ipt);
		});
		...
		li=$(" <li><a href='javascript:;'>对话框树型选择[单选]</a></li>").bind("click",function(){
			var ipt=$("<span><input autocomplete='off'   type='text' authCfg='1,2,3,4,5,6,7,8,9' class='lingx-wf-dialogtree lingx-wf-ipt' readonly /><button type='button' >选择</button></span>");
			_this.addId(ipt);
			_this.bindClick(ipt);
			_this.currentEl.append(ipt);
		});
		...
		li=$(" <li><a href='javascript:;'>对话框树型选择[多选]</a></li>").bind("click",function(){
			var ipt=$("<span><input autocomplete='off'   type='text' authCfg='1,2,3,4,5,6,7,8,9' class='lingx-wf-dialogtree2 lingx-wf-ipt' readonly /><button type='button' >选择</button></span>");
			_this.addId(ipt);
			_this.bindClick(ipt);
			_this.currentEl.append(ipt);
		});
...
/*		li=$(" <li><a href='javascript:;'>bootstarp yyyy-MM-dd</a></li>").bind("click",function(){
			var ipt=$("<div class='input-group date form_date' data-date='' data-date-format='yyyy-mm-dd' data-link-field='dtp_input2' data-link-format='yyyy-mm-dd'>                    <input autocomplete='off'   class='form-control' size='16' type='text' value='' readonly>                    <span class='input-group-addon'><span class='glyphicon glyphicon-remove'></span></span>					<span class='input-group-addon'><span class='glyphicon glyphicon-calendar'></span></span>                </div>         <input autocomplete='off'   type='hidden' id='dtp_input2' value='' />");
			_this.addId(ipt);
			_this.bindClick(ipt);
			_this.currentEl.append(ipt);
		...
		li=$(" <li><a href='javascript:;'>日期 yyyy-MM-dd</a></li>").bind("click",function(){
			var ipt=$("<span> <input autocomplete='off'  type='text' class='form_date lingx-wf-ipt' readonly='readonly' authCfg='1,2,3,4,5,6,7,8,9' data-date-format='yyyy-mm-dd'> </span>");
			_this.addId(ipt);
			_this.bindClick(ipt);
			_this.currentEl.append(ipt);
			$('.form_date').datetimepicker({
...
/*		li=$(" <li><a href='javascript:;'>bootstarp yyyy-MM-dd HH:mm</a></li>").bind("click",function(){
		...
		li=$(" <li><a href='javascript:;'>日期时间 yyyy-MM-dd HH:mm</a></li>").bind("click",function(){
			var ipt=$("<span> <input autocomplete='off'  type='text' class='form_datetime lingx-wf-ipt' readonly='readonly' authCfg='1,2,3,4,5,6,7,8,9' data-date-format='yyyy-mm-dd hh:ii'> </span>");
			_this.addId(ipt);
			_this.bindClick(ipt);
			_this.currentEl.append(ipt);
			 $('.form_datetime').datetimepicker({
